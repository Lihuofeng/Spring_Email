...
public class EmailUtils {
	...
	//Thymeleaf
	public String sendMailThymeleaf(String subject, String location, String emailAdress, JavaMailSender javaMailSender,
		...
		try {
			...
			String emailText =templateEngine.process("example.html", ctx);
			mMessageHelper.setText(emailText, true);
			// 通过文件路径获取文件名字
			String filename = StringUtils.getFileName(location);
			// 定义要发送的资源位置
			File file = new File(location);
